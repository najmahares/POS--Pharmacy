...
def get_low_stock_products(
    ...
    """Get products with low stock. Requires inventory manager or admin role."""
...
def get_expired_products(
    ...
    """Get expired products. Requires inventory manager or admin role."""
...
def create_product(
    ...
    """Create a new product. Requires inventory manager or admin role."""
...
def update_product(
    ...
    """Update an existing product. Requires inventory manager or admin role."""
    product = product_repository.get(db, product_id)
    if not product:
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
